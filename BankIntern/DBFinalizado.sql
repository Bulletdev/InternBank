...
VALUES
('Joao Silva', '12345678901', 'joao@email.com', '11999999999', 'Rua A, 123', '01001000', 'Centro', N'São Paulo', '123', 'senha123', 1),
...
-- Relacao entre as tabelas Conta e Usuario
SELECT 
    c.Conta_id,
    c.Agencia,
    c.Numero_Conta,
...
--Rela��o de pagamentos, conta ID e Usuario ID
SELECT
	p.Pagamento_id,
	c.Conta_id,
	c.Usuario_id
...
-- transa��es relacionada a contas
SELECT 
	t.Transacoes_id,
	t.Pix_id,
	t.Pagamento_id,
...
--transa��es relacionada a extrato
SELECT 
    t.Transacoes_Id,
    e.Extrato_Id
FROM Transacoes t
...
-- transa��es relacionada a dep�sito
SELECT 
    t.Transacoes_Id,
    d.Deposito_id,
...
-- transa��es relacionada a transfer�ncia
SELECT 
    t.Transacoes_Id,
    tf.Transferencia_id,
